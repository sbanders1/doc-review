...
<div class="flex-1 min-h-0 overflow-auto bg-gray-200 dark:bg-gray-900 relative" bind:this={scrollArea} onclick={handleClick}>
  <div class="page-wrapper relative min-h-full" bind:this={pageWrapper}>
    {#if renderError}
      <div class="px-6 py-6 text-center text-red-500 text-sm">{renderError}</div>
    {/if}
    <div class="docx-content flex flex-col items-center py-5 gap-5" bind:this={docxContentEl}></div>
