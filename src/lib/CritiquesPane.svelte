<script>
  ...
  import { setActiveCitationId } from './citations.svelte.js';
  import { undo, getUndoToast } from './commandHistory.svelte.js';
  ...
  const annotations = $derived(allAnnotations.filter(a => a.author !== 'argument-spotlight'));
